        ...
        <div>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <div>
                        <div className="absolute left-10 md:left-16 right-6 top-5 md:top-32 lg:top-44 lg:left-72 lg:right-2 lg:bottom-1/4 z-20 lg:h-2/6 lg:w-6/12 text-center items-center justify-center" >
